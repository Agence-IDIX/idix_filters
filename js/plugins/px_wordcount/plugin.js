...
CKEDITOR.plugins.add("wordcount", {
    ...
    init: function (editor) {
        ...
        pxNbspLoaded = typeof editor.plugins.px_nbsp != 'undefined';
       ...
       function counterId(editorInstance) {
        ...
        function strip(html) {
            ...
            // on zappe la détection du plugin px_nbsp, qui déconne dans certains cas à cause de l'init à la volée de px_wordcount....
            //if(pxNbspLoaded){
                html = html.replace(/\[px_nbsp:(nbsp|thinsp)\]/gi, ' ');
            //}

 ...
 *
 * @FieldWidget(
 *   id = "text_idix_textarea_with_summary",
 *   label = @Translation("IDIX Text area with a summary"),
 *   field_types = {
 *     "text_with_summary"
 *   }
 * )
 */
class IdixTextareaWithSummaryWidget extends TextareaWithSummaryWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if($wordcount_enable){
      ...
      $element['#attributes']['data-idix-wordcount'] = 'enabled';
